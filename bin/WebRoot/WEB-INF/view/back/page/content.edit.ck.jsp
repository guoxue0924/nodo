                        ...
                        <div data-toggle="buttons" class="btn-group pull-right">
                            <c:choose>
                            	<c:when test="${content !=null}">
                            		<a href="${BASE_URL}/back/pageContent/edit?et=ck&contentId=${content.id}" class="btn btn-sm btn-default load-content active">
                            	</c:when>
                            	<c:otherwise>
                            		<a href="${BASE_URL}/back/pageContent/add?et=ck" class="btn btn-sm btn-default load-content active">
                            	</c:otherwise>
                            </c:choose>
                            ...
                            <c:choose>
                            	<c:when test="${content !=null}">
	                            	<a href="${BASE_URL}/back/pageContent/edit?et=cm&contentId=${content.id}" class="btn btn-sm btn-default load-content">
	                            </c:when>
                            	<c:otherwise>
	                            	<a href="${BASE_URL}/back/pageContent/add?et=cm" class="btn btn-sm btn-default load-content">
	                            </c:otherwise>
                            </c:choose>
