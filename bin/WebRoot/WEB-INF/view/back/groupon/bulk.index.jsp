            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/grouponBulk/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/back/grouponBulk/page" id="searchForm">
...
<script src="${STATIC_URL}/back/modules/groupon/js/bulk.index.js" type="text/javascript"></script>