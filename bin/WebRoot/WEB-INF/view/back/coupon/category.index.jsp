...
<link href="${STATIC_URL}/back/modules/coupon/css/category.index.css" rel="stylesheet" type="text/css"/>
            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/couponCategory/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/back/couponCategory/page" id="searchForm">
                    ...
                    <div class="col-sm-3 m-b-xs pull-right">
                        <div class="input-group">
                            <input type="text" name="key" class="input-sm form-control" placeholder="优惠券名称"/>
...
<script src="${STATIC_URL}/back/modules/coupon/js/category.index.js" type="text/javascript"></script>