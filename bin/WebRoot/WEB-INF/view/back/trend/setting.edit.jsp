    ...
    <aside class="aside-md bg-white b-r">
        <section class="vbox">
            ...
            <section class="scrollable wrapper panel w-f">
                <form class="form-horizontal" action="${BASE_URL}/back/trendadmin/setting/add" method="post" id="edit_form">
...
<script src="${STATIC_URL}/back/modules/trend/js/setting.edit.js"></script>