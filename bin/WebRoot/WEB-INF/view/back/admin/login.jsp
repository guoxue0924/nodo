...
<head>
	...
	<link rel="stylesheet" href="${STATIC_URL}/back/css/animate.css" type="text/css"/>
	<link rel="stylesheet" href="${STATIC_URL}/back/css/apps.css" type="text/css"/>
	<link rel="stylesheet" href="${STATIC_URL}/back/modules/admin/css/login.css" type="text/css"/>
...
<body>
<!-- 主页请求跳转 -->
<a class="navbar-brand block" href="/back/admin">${SITE_NAME}</a>
<div>
<section id="aui_iwrapper" class="animated fadeInUp aui-iwrapper">
    <section class="panel panel-default bg-white m-t-lg">
        ...
        <form action="${BASE_URL}/back/adminLogin/login" id="form_sign"  class="panel-body wrapper-lg" method="post" title="登录" data-validate="parsley">
            ...
            <div class="form-group">
                <img src="${BASE_URL}/back/adminLogin/code" alt="点击换一张" id="vcodeimg" title="看不清楚，换一张" style="cursor:pointer;" onclick="this.src='${BASE_URL}/back/adminLogin/code?t='+Math.random();" >
            </div>
...
<script src="${STATIC_URL}/back/modules/admin/js/login.js"></script>
</html>