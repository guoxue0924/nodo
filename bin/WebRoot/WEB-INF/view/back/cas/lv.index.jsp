    ...
    <aside>
        <section class="vbox">
            <header class="header bg-white b-b clearfix">
            	<form action="${BASE_URL}/back/casuserLevel/page" id="searchForm" ></form>
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        <div class="btn-group">
                            <button type="button" class="btn btn-sm btn-default action-refresh" title="Refresh"><i class="fa fa-refresh"></i></button>
                        </div>
                        <a href="${BASE_URL}/back/casuserLevel/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                </div>
            </header>
...
<script src="${STATIC_URL}/back/modules/cas/js/lv.index.js"></script>