    ...
    <aside class="aside-md bg-white b-r">
        <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
                <form class="form-horizontal" id="editForm" action="${BASE_URL}/back/casuserGroup/add" method="post">
...
<script src="${STATIC_URL}/back/modules/cas/js/group.edit.js" type="text/javascript"></script>