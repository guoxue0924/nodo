        ...
        <section class="vbox">
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    ...
                    <form class="form-inline" action="${BASE_URL}/back/order/page" id="searchForm" method="post">
...
<script src="${STATIC_URL}/back/modules/bts/js/order.index.js" type="text/javascript"></script>