        ...
        <div class="row m-t-sm">
            <div class="col-sm-8 m-b-xs">
                <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-sm btn-default" id="action_delete" title="Remove"><i class="fa fa-trash-o"></i></button>
                </div>
                <a href="${BASE_URL}/back/goodsCategory/add" data-toggle="ajaxModal" class="btn btn-sm btn-default" id="modal_brand"><i class="fa fa-plus"></i> 添加</a>
            </div>
            <form class="form-inline" action="${BASE_URL}/back/goodsCategory/page" id="searchForm">
            <div class="col-sm-4 m-b-xs" id="search">
                <div class="input-group">
                    <input type="text" name="key" class="input-sm form-control" placeholder="分类名称" />
...
<script src="${STATIC_URL}/back/modules/goods/js/category.index.js"></script>