            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/advertBoard/add" class="btn btn-sm btn-default" data-toggle="ajaxModal"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/back/advertBoard/page" id="searchForm">
                    <div class="col-sm-7 m-b-xs text-right p-right-0">
                            <div class="form-group">
                                <select name="pageId" class="form-control input-sm">
                    ...
                    <div class="col-sm-3 m-b-xs">
                        <div class="input-group">
                            <input type="text" name="key" class="input-sm form-control" placeholder="广告位名称" />
...
<script src="${STATIC_URL}/back/modules/advert/js/board.index.js"></script>