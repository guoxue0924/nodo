            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/advertPage/add" class="btn btn-sm btn-default" data-toggle="ajaxModal"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    
                    <form class="form-inline" action="${BASE_URL}/back/advertPage/page" id="searchForm">
...
<script src="${STATIC_URL}/back/modules/advert/js/page.index.js"></script>