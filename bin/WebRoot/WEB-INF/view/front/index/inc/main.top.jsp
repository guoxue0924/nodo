...
<div class="public-top-layout w">
    <div class="topbar wrapper">
      ...
      <a href="${BASE_URL}/front/cas/index">${loggedInUser.username}</a>
            <div class="nc-grade-mini" style="cursor:pointer;" onclick="javascript:go('${BASE_URL}/front/cas/index');">V0
            </div>
            </span> ，欢迎来到 <a href="" title="首页" alt="首页"><span> bluemobi v3</span></a> <c:choose><c:when test="${loggedInUser == null}"><span>[<a href="${BASE_URL}/front/cas/login">登录</a>]&nbsp;[<a href="${BASE_URL}/front/cas/register">注册</a>]</span></c:when><c:otherwise><span>[<a
