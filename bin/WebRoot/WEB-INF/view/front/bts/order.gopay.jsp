        ...
        <form action="" method="POST" id="buy_form">
            ...
            <div class="ncc-receipt-info">
                <div class="ncc-receipt-info-title">
                    <h3>请您及时付款，以便订单尽快处理！                    在线支付金额：<strong><fmt:formatNumber value="${order.totalAmount}" pattern="￥#,#00.00#"/></strong>
                    </h3>
                </div>
                <table class="ncc-table-style">
                    ...
                    <tr>
                        <td></td>
                        <td class="tl" id="ordernubmer">${order.orderNumber}</td>
                        <td class="tl">在线支付</td>
                        <td class="tl"><fmt:formatNumber value="${order.totalAmount}" pattern="￥#,#00.00#"/></td>
                        <td>快递</td>
                    </tr>
                    </tbody>
                </table>
                ...
                <ul class="ncc-payment-list">
                    <li payment_code="alipay" class="using">
                        <label for="pay_alipay">
                            <i></i>
                            <div class="logo" for="pay_2"> <img src="${STATIC_URL}/front/images/bts/alipay_logo.gif"> </div>
                        </label>
                    </li>   
                </ul>
            </div>
            <div class="ncc-bottom tc mb50"><a href="JavaScript:void(0);" onclick="pay()" id="next_button" class="ncc-btn ncc-btn-green"><i class="icon-shield"></i>确认提交支付</a></div>
        </form>
    </div>
</div>
