                ...
                <dd>${order.orderNumber}<a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
                    <div class="more"><span class="arrow"></span>
                        <ul>
                            ...
                            <li>下单时间：<span>${order.ctime}</span></li>
                        </ul>
                    </div>
                </a></dd>
            </dl>
    ...
    <table class="ncm-default-table order">
        ...
        <tr class="bd-line">
            ...
            <td class="tl">
                <dl class="goods-name">
                    <dt>
                        <a href="" target="_blank" title="${item.goodsName}">${item.goodsName}</a>
                    </dt>
                </dl> 
            </td>
            <td></td>
...
<script type="text/html" id="status2">
    ...
    <ul>
        <li>1. 您尚未对该订单进行支付，请<a href="" class="ncm-btn-mini ncm-btn-orange"><i></i>支付订单</a>以确保商家及时发货。</li>
