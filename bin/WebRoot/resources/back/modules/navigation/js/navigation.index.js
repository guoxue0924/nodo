...
function publishNavigation(id) {
	$.ajax({
    	type:'post',
        url:BASE_URL + '/back/navigation/publish',
...
function doDelete(id, $tr) {
	...
	$.ajax({
    	type:'post',
        url:BASE_URL + '/back/navigation/delete',
        data:'navigationId=' + id,
        dataType:'json',
        timeout:60000,
        success:function(data){
...
function formatData(items) {
	$.each(items, function (index, item) {
    	...
    	item.operate = '<a href="' + BASE_URL + '/back/navigation/edit/?navigationId=' + item.navigationId + '" data-toggle="ajaxModal" class="operate-edit" title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;' + 
