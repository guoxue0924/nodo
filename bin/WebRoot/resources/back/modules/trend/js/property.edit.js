...
function insert_property_value() {
	...
	$.ajax({
    	type:'post',
        url:BASE_URL + '/back/trendProperty/insertPropertyValue',
...
function delete_property_value(propertyValueId) {
	$.ajax({
    	type:'post',
        url:BASE_URL + '/back/trendProperty/deletePropertyValue',
...
//		var uploadImageName = $("input[name='p_property_image_"+k+"']").val();
	...
	if (propertyId == '' || propertyId == 0) {
		...
		$("#edit_form").attr("action", BASE_URL + "/back/trendProperty/edit");
