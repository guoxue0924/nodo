...
public class AnnotationHandlerMethodExceptionResolver extends
	...
	protected ModelAndView doResolveHandlerMethodException(
		...
		if(responseBodyAnn != null) {
			try {
				...
				if(returnValue == null) {
					ResultTO res = ResultTO.newFailResultTO("系统异常：" + exception.getLocalizedMessage(), null);
	...
	private ModelAndView handleResponseError(ResultTO returnValue, HttpServletRequest request,
