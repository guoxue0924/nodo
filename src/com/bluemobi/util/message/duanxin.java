...
public class duanxin {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        /**************** 查账户信息调用示例 *****************/
        System.out.println(duanxin.getUserInfo(apikey));
        ...
        System.out.println(duanxin.tplSendSms(apikey, tpl_id, tpl_value, mobile));
    ...
    public static String sendSms(String apikey, String mobile) throws IOException {
        Map<String, String> params = new HashMap<String, String>();
//      String text="尊敬的用户您于"+System.nanoTime()+"申请可美会员，您的手机验证码是"+randomNum();
        params.put("apikey", apikey);
