...
<link href="${STATIC_URL}/back/modules/navigation/css/navigation.css" rel="stylesheet" type="text/css" />
...
<div class="modal-dialog" id="modal_edit">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="${BASE_URL}/back/navigation/add" method="post" id="edit_form">
...
<script src="${STATIC_URL}/back/modules/navigation/js/navigation.edit.js"></script>
<!-- {literal} -->
