    ...
    <aside class="aside-md bg-white b-r">
        <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
                <form class="form-horizontal" id="edit_form" action=<c:choose> <c:when test="${logUserAction!=null}">"${BASE_URL}/back/logUserAction/edit"</c:when><c:otherwise>"${BASE_URL}/back/logUserAction/add"</c:otherwise></c:choose> method="post">
...
<script src="${STATIC_URL}/back/modules/log/js/userAction.edit.js" type="text/javascript"></script>
<!-- / modal - 编辑-->