            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/advertContent/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    
                    <form class="form-inline" action="${BASE_URL}/back/advertContent/page" id="searchForm">
                    <div class="col-sm-7 m-b-xs text-right p-right-0">
                            <div class="form-group">
                                <select id="pageId" name="pageId" class="form-control input-sm">
                                    <option value="0">请选择广告页面</option>
                                    <c:forEach items="${pages}" var="v">
                                    <option value="${v.pageId}">${v.title}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            
                            <div class="form-group">
                                <select name="boardId" class="form-control input-sm">
                    ...
                    <div class="col-sm-3 m-b-xs">
                        <div class="input-group">
                            <input type="text" name="key" class="input-sm form-control" placeholder="广告标题" />
...
<script src="${STATIC_URL}/back/modules/advert/js/content.index.js"></script>