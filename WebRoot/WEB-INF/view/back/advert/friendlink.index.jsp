            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/friendlink/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    
                    <form class="form-inline" action="${BASE_URL}/back/friendlink/page" id="searchForm">
                    <div class="col-sm-4 m-b-xs">
                        <div class="input-group">
                            <input type="text" name="key" class="input-sm form-control" placeholder="友情链接名称" />
...
<script src="${STATIC_URL}/back/modules/advert/js/friendlink.index.js"></script>