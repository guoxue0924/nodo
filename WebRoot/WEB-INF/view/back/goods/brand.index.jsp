    ...
    <header class="header bg-white b-b clearfix">
        <div class="row m-t-sm">
            <div class="col-sm-8 m-b-xs">
                ...
                <a href="${BASE_URL}/back/goodsBrand/add" data-toggle="ajaxModal" class="btn btn-sm btn-default" id="modal_brand"><i class="fa fa-plus"></i> 添加</a>
            </div>
            
            <form class="form-inline" action="${BASE_URL}/back/goodsBrand/page" id="searchForm">
...
<script src="${STATIC_URL}/back/modules/goods/js/brand.index.js"></script>