...
<link href="${STATIC_URL}/back/modules/goods/css/index.index.css" rel="stylesheet" type="text/css" />
...
<section class="hbox stretch">
	...
	<aside class="bg-white">
		<section class="vbox">
			...
			<section class="scrollable w-f">
				<form class="form-horizontal h-100" id="edit_form" action="${BASE_URL}/back/goodsContent/add" method="post" enctype="multipart/form-data">
					...
					<!-- 上传图片 @start -->
					<jsp:include page="content.edit.image.jsp" />
					<!-- 上传图片 @end -->
...
<script src="${STATIC_URL}/back/modules/goods/js/content.edit.js" type="text/javascript"></script>
<script src="${STATIC_URL}/back/modules/goods/js/content.edit.base.js" type="text/javascript"></script>
<script src="${STATIC_URL}/back/modules/goods/js/content.edit.content.js" type="text/javascript"></script>
<script src="${STATIC_URL}/back/modules/goods/js/content.edit.image.js" type="text/javascript"></script>
<script src="${STATIC_URL}/back/modules/goods/js/content.edit.related.js" type="text/javascript"></script>
