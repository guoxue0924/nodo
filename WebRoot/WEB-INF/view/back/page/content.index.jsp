            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/pageContent/add" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/back/pageContent/page" id="searchForm">
	                    <div class="col-sm-3 m-b-xs pull-right">
	                        <div class="input-group">
	                            <input type="text" name="key" class="input-sm form-control" placeholder="网页标题" />
...
<script src="${STATIC_URL}/back/modules/page/js/content.index.js" type="text/javascript"></script>