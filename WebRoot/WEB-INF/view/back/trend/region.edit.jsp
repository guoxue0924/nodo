...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="${BASE_URL}/back/trend/region/add" method="post" id="edit_form">
                ...
                <div class="form-group">
                    <label for="express_fee" class="col-sm-3 control-label"><font class="red">* </font>快递费</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="expressFee" name="expressFee" value="${region.expressFee}" placeholder="请输入快递费" />
                    </div>
                </div>
...
<!-- / modal - 编辑地区 -->
<script src="${STATIC_URL}/back/modules/trend/js/region.edit.js"></script>