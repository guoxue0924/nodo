                ...
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        <div class="btn-group" id="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-default hide" id="action_delete" title="Remove"><i class="fa fa-trash-o"></i></button>
                        </div>
                    </div>
                    <form action="${BASE_URL}/back/commentadmin/trash/page" id="searchForm">
...
<script src="${STATIC_URL}/back/modules/comment/js/trash.index.js"></script>