        ...
        <section class="vbox">
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    ...
                    <form class="form-inline" action="${BASE_URL}/back/commentadmin/page" id="searchForm">
                    <div class="col-sm-4 m-b-xs">
                        <div class="input-group">
                            <input type="text" name="key" class="input-sm form-control" placeholder="请输入评论内容" />
                            <span class="input-group-btn">
                                <button class="btn btn-sm btn-default action-refresh" type="button">搜索</button>
                            </span>
                            <span class="input-group-btn">
                                <button class="btn btn-sm btn-default action-refresh" type="button" id="action_excel">导出Excel</button>
                            </span>
                        </div>
                    </div>
                    </form>
...
<script src="${STATIC_URL}/back/modules/comment/js/index.index.js"></script>
