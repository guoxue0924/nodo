                ...
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-default" id="action_trash" title="删除"><i class="fa fa-times"></i></button>
                        </div>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/back/articleRecycle/page" id="searchForm">
...
<script src="${STATIC_URL}/back/modules/article/js/recycle.index.js" type="text/javascript"></script>