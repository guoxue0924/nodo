    ...
    <div class="modal-content">
	    ...
	    <div class="modal-body">
	    	<form class="form-horizontal" id="edit_form" 
	    		action=	<c:choose> <c:when test="${category!=null}">"${BASE_URL}/back/articleCategory/edit"</c:when><c:otherwise>"${BASE_URL}/back/articleCategory/add"</c:otherwise></c:choose>
				method="post">
				
		        <div class="form-group">
					<label for="parentId" class="col-sm-3 control-label">父级分类</label>
					<div class="col-sm-7">
...
<script src="${STATIC_URL}/back/modules/article/js/category.edit.js" type="text/javascript"></script>