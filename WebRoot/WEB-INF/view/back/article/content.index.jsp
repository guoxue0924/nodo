                ...
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-default" id="action_trash" title="删除(扔进回收站)"><i class="fa fa-trash-o"></i></button>
                        </div>
                        <a href="${BASE_URL}/back/articleContent/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/back/articleContent/page" id="searchForm">
	                    ...
	                    <div class="col-sm-3 m-b-xs pull-right">
	                        <div class="input-group">
	                            <input type="text" name="key" class="input-sm form-control" placeholder="文章标题" />
...
<script src="${STATIC_URL}/back/modules/article/js/content.index.js" type="text/javascript"></script>