            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/articleCategory/add" class="btn btn-sm btn-default" data-toggle="ajaxModal"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    <form class="form-inline" action="${BASE_URL}/back/articleCategory/page" id="searchForm">
...
<script src="${STATIC_URL}/back/modules/article/js/category.index.js" type="text/javascript"></script>