...
<link href="${STATIC_URL}/scripts/codemirror/4.3/lib/codemirror.css" rel="stylesheet" type="text/css" />
<link href="${STATIC_URL}/scripts/codemirror/4.3/addon/display/fullscreen.css" rel="stylesheet" type="text/css" />
            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/promotionGoods/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
                    <form action="${BASE_URL}/promotionGoods/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/promotion/js/goods.index.js" type="text/javascript"></script>