            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/back/grouponCategory/add" class="btn btn-sm btn-default" data-toggle="ajaxModal"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    
                    <form action="${BASE_URL}/back/grouponCategory/page" id="searchForm">
                    <div class="col-sm-3 m-b-xs pull-right">
                        <div class="input-group">
                            <input type="text" name="key" class="input-sm form-control" placeholder="标签名称" />
...
<script src="${STATIC_URL}/back/modules/groupon/js/category.index.js" ></script>