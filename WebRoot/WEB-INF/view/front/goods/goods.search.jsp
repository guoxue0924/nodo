                ...
                <div class="nch-sortbar-array"> 排序方式：
                    <ul>
                        <li class='${empty sort ? "selected" : ""}'>
                            <a href="${BASE_URL}/front/goodsContent/search?categoryId=${categoryId}" title="默认排序">默认</a>
                        </li>
                        <li class='${sort eq "salesVolume" ? "selected" : ""}'>
                            <a href="${BASE_URL}/front/goodsContent/search?sort=salesVolume&categoryId=${categoryId}" title="点击按销量从高到低排序">销量<i></i></a>
                        </li>
                        <li class='${sort eq "price" ? "selected" : ""}'>
                            <a href="${BASE_URL}/front/goodsContent/search?sort=price&categoryId=${categoryId}" title="点击按价格从高到低排序">价格<i></i></a>
                        </li>
                    </ul>
                </div>
            </nav>
	                        ...
	                        <li class="item">
	                            <div class="goods-content" nctype_goods="${g.contentId}">
	                                ...
	                                <div class="goods-info" style="top: 230px;">
	                                    ...
	                                    <div class="add-cart">
	                                        <a href="javascript:void(0);" nctype="add_cart" class="addcart" data-param="${g.contentId}">
												<!-- modify by fxz 2016-07-11 begin -->
	                                        	<input type="hidden" value="${g.skus[0].skuId}" name="skuId" id="skuId"/>
