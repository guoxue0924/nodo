...
<!--                         <span class="tag">限时抢购</span> -->
                ...
                <dl>
                    <dt>积&nbsp;分&nbsp;价：</dt>
                    <dd class="priceIntegral">
                    
                    	<c:choose> 
                    		<c:when test="${skuDetail.priceIntegral==0}"> 
                    			<strong id="priceIntegral"><fmt:formatNumber value="${skuDetail.price*10}"  /></strong>
							</c:when>
							<c:otherwise> 
								<strong id="priceIntegral"><fmt:formatNumber value="${skuDetail.priceIntegral}"  /></strong>
							</c:otherwise>
						</c:choose>
                    </dd>
                </dl>
...
<form id="buynow_form" method="post" action="${BASE_URL}/front/bts/order/fastCheck">
   <input id="fastSkuId" name="fastSkuId" type="hidden">
    <input id="fastQuantity" name="fastQuantity" type="hidden">
