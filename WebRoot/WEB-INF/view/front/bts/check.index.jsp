...
<div class="ncc-wrapper">
    <form method="post" id="order_form" name="order_form" action="${BASE_URL}/front/bts/order/payAll">
        <!-- S fcode -->
        <div class="ncc-main">
            <div class="ncc-title">
                <h3>填写核对购物信息</h3>
                ...
                <div id="addr_list" class="ncc-candidate-items">
                    <ul >
                        <li>
				      		...
				      		<span id="consigneeName" class="true-name">${consignee.name}</span>
				      		<span id="regionName" class="address">${consignee.regionName}${consignee.address}</span>
				      		<span id="mobile" class="phone"><i class="icon-mobile-phone"></i>${consignee.mobile}</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<%--                         <td class="w120"><em id="item${c.cartId}_subtotal" nc_type="eachGoodsTotal">${c.subprice}</em> --%>
                        <td class="w120"><em id="item${c.cartId}_subtotal" nc_type="eachGoodsTotal">${(c.price*c.quantity).doubleValue()}</em>
                        </td>
                        <td></td>
                    </tr>
                        <!--立即购买-->
                    ...
                    <tr>
                        ...
                        <td class="tl" colspan="2">买家留言：
                            <textarea name="remark" id="remark" class="ncc-msg-textarea" placeholder="选填：对本次交易的说明（建议填写已经和商家达成一致的说明）" title="选填：对本次交易的说明（建议填写已经和商家达成一致的说明）" maxlength="150"></textarea></td>
                    ...
                    <tr>
                        <td class="tr" colspan="20">
                            <div class="ncc-store-account">
                                <dl class="freight">
                                    <dt>运费：</dt>
                                    <dd><em id="eachStoreFreight">${expressFee }</em>元</dd>
                                </dl>
                                <dl>
                                    <dt>商品金额：</dt>
                    ...
                    <tr>
                    	...
                    	<td >
                         ...
                         <td>
                         	<div class="ncc-all-account" align="left">现金支付</div> 
                        </td>
                        <td >
                        	<div class="ncc-all-account" align="right">
                        		<em id="orderTotal">${totalprice}</em>
                        	</div>
                        </td>
                  		<td>
                        	<div align="right">
                        		<font size="3" color="res">元&nbsp;&nbsp;</font>
                        	</div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="30%"> 
                        	<div class="ncc-all-account" align="left">积分支付</div> 
                         </td>
                        <td >
                        	<div class="ncc-all-account" align="right">
                        		<em id="orderTotal">${countPoint}</em>
                        	</div>
                        </td>
                        <td>
                        	<div align="right">
                        		<font size="3" color="res">积分&nbsp;</font>
                        	</div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td> 
                        	<div class="ncc-all-account" align="left">积分+现金支付&nbsp;&nbsp;(1人民币=10积分)</div> 
                         </td>
                        <td colspan="2" >
                        	<div  align="left">
                        		<input type="text" name="checkitRMB" style="width: 45px" value=""><em id="orderTotal"></em>
								<font size="3" color="res">元&nbsp;&nbsp;&nbsp;+&nbsp;&nbsp;</font>
                        		
                        		<input type="text" name="checkitJF" style="width: 45px" value=""><em id="orderTotal"></em>
								<font size="3" color="res">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;积分</font>
                        	</div>
                        </td>
                    </tr>
            ...
            <div class="ncc-bottom"> 
            	...
            	<ul>
	            	<li>
	            		<a href="javascript:void(0)" id="submitOrder" class="ncc-btn ncc-btn-acidblue fr">
	            			提交订单并支付
	            		</a> 
	            	</li>
            	</ul>
            ...
            <input value="${countPoint}" name="countPoint" id="countPoint" type="hidden">
        </div>
    </form>
