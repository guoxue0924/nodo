    ...
    <div class="content">
        <form action="alipayapi.jsp" class="alipayform" method="POST" target="_blank">
            ...
            <div class="element">
                ...
                <div class="einput">
                	<input type="text" name="WIDout_trade_no" id="out_trade_no">
					<%-- <dl>
<!--                         <dt>商品金额：</dt> -->
                        <dd><fmt:formatNumber value="${orderPaylist.outOrderNumber}" pattern="￥#,#00.00#"/></dd>
                    </dl> --%>
                </div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput">
                	...
                	<%-- <dl>
                        <dd><fmt:formatNumber value="${orderPaylist.orderNumber}" pattern="￥#,#00.00#"/></dd>
                    </dl> --%>
                </div>
                <br>
            ...
            <div class="element">
<!--                 <input type="submit" class="alisubmit" value ="确认支付">useAliPay -->
                <a href="${BASE_URL}/front/bts/order/pay/useAliPay?orderNumber=${order.orderNumber}">
