	...
	<div class="wrapper">
		<div class="all-category">
			...
			<div class="title">
				...
				<h3>
					<a href="${BASE_URL}/front/goodsContent/Allsearch" style='text-decoration:none;'>所有商品分类</a>
				</h3>
			</div>
							...
							<div class="sub-class" cat_menu_id="1" style="display: none; top: -1px;">
								...
								<div class="sub-class-right">
									<div class="brands-list">
										<ul>
                                            <c:forEach items="${BrandsbyCategory}" var="brand" varStatus="status">
                                            <!-- modify by guoxue 2016/06/22 begin  -->
                                             <c:if test="${brand.categoryId == c.categoryId }"> 
<%--     											<li><a title="${brand.brandName}" href="#"><img width="90"  heiht="30" src="${IMG_URL}${brand.brandLogo}"><span>${brand.brandName}</span> </a></li> --%>
    											<li><a title="${brand.brandName}" href="${BASE_URL}/front/goodsContent/search?brandId=${brand.brandId}"><img width="90"  heiht="30" src="${IMG_URL}${brand.brandLogo}"><span>${brand.brandName}</span> </a></li>
                                             </c:if> 
                                             <!-- modify by guoxue 2016/06/22 end  -->
                                            </c:forEach>
										</ul>
									</div>
