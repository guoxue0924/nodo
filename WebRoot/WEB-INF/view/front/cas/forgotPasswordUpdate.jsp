...
<div class="nc-login-layout">
    <div class="nc-login" id="aui_iwrapper">
        ...
        <div class="nc-login-content">
            <form id="register_form" method="post" action="${BASE_URL}/front/cas/updateNewPassword" novalidate="novalidate">
            <dl>
                <dt>用&nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;名</dt>
                <dd style="min-height:54px;">
                    <input type="text" id="username" name="username" class="text tip error" title="3-15位字符，可由中文、英文、数字及“_”、“-”组成" value="${phone}" autofocus="" Readonly>
            ...
            <dl>
                <dt>&nbsp;</dt>
                <dd>
                      <input type="submit" id="sign_submit" value="提交申请" class="submit" title="提交申请">
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript" src="${STATIC_URL}/front/modules/cas/js/forgotPasswordUpdate.js" charset="utf-8"></script>