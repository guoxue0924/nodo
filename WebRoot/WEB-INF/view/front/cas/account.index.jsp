...
<link rel="stylesheet" type="text/css" href="${STATIC_URL}/front/modules/cas/css/tcal.css" />
<script type="text/javascript" src="${STATIC_URL}/front/modules/cas/js/tcal.js"></script> 
            ...
            <div class="ncm-default-form fr">
                <form method="post" id="edit_form" action="${BASE_URL}/front/cas/account">
                    ...
                    <dl>
                        ...
                        <dd>
                            <span class="w400">
                            <input type="text"  class="tcal" name="birthday"  id="birthday" value="${userDetail.birthday}"
                   readonly="readonly">
