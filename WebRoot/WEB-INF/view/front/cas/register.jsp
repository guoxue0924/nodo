...
<%--                 	 <a href="${BASE_URL}/front/cas/sendShortMessage?phone=${phone}">发送手机验证码</a> --%>
            ...
            <dl>
                <dt>验&nbsp;&nbsp;&nbsp;证&nbsp;&nbsp;&nbsp;码</dt>
                <dd style="min-height:54px;">
                    <input type="text" id="captcha" name="captcha" class="text w50 fl tip error" maxlength="4" size="10" title="请输入验证码，不区分大小写" style="width: 500px;height: 20px" />
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span for="clause" class="ml5">阅读并同意<a href="${BASE_URL}/front/cas/agreement" target="_blank" class="agreement" title="阅读并同意">服务协议</a></span>
