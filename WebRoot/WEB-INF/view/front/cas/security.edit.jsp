...
<script type="text/html" id="password">
    <div class="wrap">
        <div class="tabmenu">
            <ul class="tab pngFix">
                <li class="normal"><a href="${BASE_URL}/front/cas/security">账户安全</a></li><li class="active"><a href="index.php?act=member_security&amp;op=auth&amp;type=modify_mobile">修改密码</a></li></ul>
        </div>
        ...
        <div class="ncm-default-form">
            <form method="post" id="mobile_form" action="${BASE_URL}/front/cas/setNewPassword">
                <input type="hidden" name="form_submit" value="ok">
                <dl>
                    <dt><i class="required">*</i>绑定手机号码：</dt>
                    <dd>
                        <p>
                            <input type="text" class="text" maxlength="11" value="${loggedInUser.username}" name="mobile" id="mobile" readonly="readonly">
                            <label for="email" generated="true" class="error"></label>
                            <a href="#" onclick="send_message_text();" id="send_auth_code" class="ncm-btn ml5"><span id="sending" style="display:none">正在</span><span class="send_success_tips" style="display: none;"><strong id="show_times" class="red mr5"></strong>秒后再次</span>获取短信验证码</a></p>
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <label for="email" generated="true" class="error"></label>
						<p id="vSuccess" style="display: none;">验证成功</p>
						<p id="vFail" style="display: none;">验证失败，请输入正确验证码</p>
                    </dd>
                </dl>
 				...
 				<dl>
                    ...
                    <dd>
                        <input type="text" class="text" maxlength="6" value="" name="newPassword" id="newPassword"  disabled="true">
                        <label for="email" generated="true" class="error"></label>
                    </dd>
                </dl>
                <dl class="bottom">
...
<script type="text/html" id="email">
    <div class="wrap">
        <div class="tabmenu">
            <ul class="tab pngFix">
                <li class="normal"><a href="${BASE_URL}/front/cas/security">账户安全</a></li><li class="active"><a href="index.php?act=member_security&amp;op=auth&amp;type=modify_email">邮箱验证</a></li></ul>
        </div>
        <div class="alert alert-success">
            <h4>操作提示：</h4>
            <ul>
        ...
        <div class="ncm-default-form">
            <form method="post" id="email_form" action="${BASE_URL}/front/cas/security/bindEmile">
                <input type="hidden" name="form_submit" value="ok">
                <dl>
    ...
    <div class="wrap">
        ...
        <div class="ncm-default-form">
            <form method="post" id="email_form" action="${BASE_URL}/front/cas/security/bindEmile">
                <input type="hidden" name="form_submit" value="ok">
                <dl>
                    <dt style="width:300px;"><i>*</i>已向邮箱发送邮件，请到邮箱进行绑定验证</dt>
                   <!-- <dd>
                        <input type="text" class="text w180" maxlength="40" value="{{email}}" name="email" id="email">
                        <label for="email" generated="true" class="error"></label>
                    </dd> 
...
<script type="text/javascript" src="${STATIC_URL}/front/modules/cas/js/security.edit.js" charset="utf-8"></script>
