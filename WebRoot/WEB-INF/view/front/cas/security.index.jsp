    ...
    <div class="wrap">
        ...
        <div class="ncm-security-user">
            ...
            <div class="user-intro">
                ...
                <dl>
                    <dt>上次登录：</dt>
                    <dd> <fmt:formatDate value="${loggedInUser.lastLoginTime}"  type="date" pattern="yyyy-MM-dd hh:mm:ss"/>　|　IP地址:${loggedInUser.lastLoginIp}&nbsp;<span>（不是您登录的？请立即<a href="${BASE_URL}/front/cas/security/edit?type=password">“更改密码”</a>）。</span>
                    </dd>
                </dl>
            </div>
        </div>
           ...
           <%--  <div class="current ${level}">当前安全等级：<strong>${security.label}</strong><span>(${security.tips})</span></div> --%>
            ...
            <dl id="email" class="${loggedInUser.verifiedEmail}">
                ...
                <dd>
                    ...
                    <c:choose><c:when test="${loggedInUser.verifiedEmail == 0}">
            ...
            <!-- delete by guoxue 2016-07-13 begin -->
            <%-- <dl id="mobile" class="">
                <dt>
                    <span class="icon"><i></i></span><span class="item">
                        <h4>手机绑定</h4>
            ...
            <!-- delete by guoxue 2016-07-13 end -->
        </div>
    </div>
</div>
<div class="clear"></div>
