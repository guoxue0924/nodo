...
function doDeleteCategory(categoryId) {
	...
	$.ajax({
    	type:'post',
        url:BASE_URL+'/back/articleCategory/delete',
...
function formatData(items) {
	$.each(items, function (index, item) {
		item.a = '';
        item.action = '<a href="'+BASE_URL+'/back/articleCategory/edit?categoryId=' + item.categoryId + '" data-toggle="ajaxModal" class="operating-edit" title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;' +
